; ModuleID = '/home/whe302/compilers/nvptx_analyzer/test/ldg_restrict.cu'
source_filename = "/home/whe302/compilers/nvptx_analyzer/test/ldg_restrict.cu"
target datalayout = "e-p6:32:32-i64:64-i128:128-i256:256-v16:16-v32:32-n16:32:64"
target triple = "nvptx64-nvidia-cuda"

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(argmem: readwrite)
define dso_local ptx_kernel void @ldg_restrict_kernel(ptr noalias noundef readonly captures(none) %a, ptr noalias noundef readonly captures(none) %b, ptr noalias noundef writeonly captures(none) %c) local_unnamed_addr #0 {
entry:
